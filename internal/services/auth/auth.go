...
func (a *Auth) RegisterNewUser(ctx context.Context, email, password, first_name, name, last_name, phone, sex string) (int64, error) {
	...
	id, err := a.usrSaver.SaveUser(ctx, email, passHash, first_name, name, last_name, phone, sex)
	if err != nil {
